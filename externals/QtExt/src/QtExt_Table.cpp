...
//			table->m_VLines[ci][ri] = m_VLines[ci][ri];
	...
	for (MergedCells m_mergedCell : m_mergedCells ) {

		if (m_mergedCell.firstRow - startRow  >= 0 && m_mergedCell.lastRow - startRow < table->m_rows){

			table->m_mergedCells.push_back(MergedCells(m_mergedCell.firstCol,
									m_mergedCell.firstRow - startRow + (startRow > 0 ? 1 : 0),
									m_mergedCell.lastCol - m_mergedCell.firstCol,
									m_mergedCell.lastRow - startRow + (startRow > 0 ? 1 : 0)));
		}
	}
