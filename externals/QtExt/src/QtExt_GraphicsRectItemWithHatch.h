	...
	*/
	...
	public:
		...
		*/
		...
		/*! Set rotated flag. When true, insulation hatch keeps vertical arcs even when w > h. */
	...
	private:
		...
		bool			m_rotated = false;	///< If true, insulation hatch uses vertical orientation regardless of aspect ratio.
