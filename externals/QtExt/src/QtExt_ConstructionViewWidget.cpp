	...
	m_fixed(true)
{
	...
	ui->actionAssign_material->setIcon(QIcon::fromTheme("assign-layer"));
	ui->actionInsert_layer_left->setIcon(QIcon::fromTheme("add-layer-before"));
	ui->actionInsert_layer_right->setIcon(QIcon::fromTheme("add-layer-after"));
	ui->actionMove_layer_left->setIcon(QIcon::fromTheme("move-layer-left"));
	ui->actionMove_layer_right->setIcon(QIcon::fromTheme("move-layer-right"));
	ui->actionRemove_layer->setIcon(QIcon::fromTheme("remove-layer"));
}
